...
if(! defined('MEMORY_LIMIT') )				define ('MEMORY_LIMIT', '200M');							// Set PHP memory limit
...
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 40485760);						// 10 Megs is 10485760. This is the max internal or external file size that we'll process.  
